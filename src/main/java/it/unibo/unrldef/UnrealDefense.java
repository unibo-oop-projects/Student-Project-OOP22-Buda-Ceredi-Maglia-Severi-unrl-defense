...
public class UnrealDefense {
	...
	public static void main(String[] args) {
		...
		.addHordeToWave(0, 10000)
		.addMultipleEnemiesToHorde(0, 1, new Orc(Optional.of(new Position(30*scale, 0))), (short)5)
		.addMultipleEnemiesToHorde(0, 1, new Goblin(Optional.of(new Position(30*scale, 0))), (short)5)
		.addHordeToWave(0, 10000)
		.addMultipleEnemiesToHorde(0, 2, new Orc(Optional.of(new Position(30*scale, 0))), (short)5)
		.addMultipleEnemiesToHorde(0, 2, new Goblin(Optional.of(new Position(30*scale, 0))), (short)5)
		.addWave()
		.addHordeToWave(1, 10000)
		.addMultipleEnemiesToHorde(1, 0, new Orc(Optional.of(new Position(30*scale, 0))), (short)5)
		.addMultipleEnemiesToHorde(1, 0, new Goblin(Optional.of(new Position(30*scale, 0))), (short)5)
		.addHordeToWave(1, 10000)
		.addMultipleEnemiesToHorde(1, 1, new Orc(Optional.of(new Position(30*scale, 0))), (short)5)
		.addMultipleEnemiesToHorde(1, 1, new Goblin(Optional.of(new Position(30*scale, 0))), (short)5)
		.addHordeToWave(1, 10000)
		.addMultipleEnemiesToHorde(1, 2, new Orc(Optional.of(new Position(30*scale, 0))), (short)5)
		.addMultipleEnemiesToHorde(1, 2, new Goblin(Optional.of(new Position(30*scale, 0))), (short)5)
