...
public final class MenuPanel extends JPanel {
    ...
    private static final Pair<Integer, Integer> TITLE_CENTER = new Pair<>(90, 80);
    ...
    public MenuPanel(final Input inputHandler) {
        ...
        this.startButton.setBounds(DEFAULT_WIDTH / 2, DEFAULT_HEIGHT / 2 + BUTTON_PADDING, BUTTON_WIDTH,
                BUTTON_HEIGHT);
    ...
    public void paint(final Graphics g) {
        ...
        this.nameField.setBounds((int) ((DEFAULT_WIDTH / 2 - CENTER) * xScale),
                (int) ((DEFAULT_HEIGHT / 2) * yScale),
